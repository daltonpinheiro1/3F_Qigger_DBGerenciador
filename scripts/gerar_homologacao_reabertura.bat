...
chcp 65001 >nul
echo ======================================================================
echo GERAR ARQUIVO DE HOMOLOGAÇÃO - REABERTURA
echo ======================================================================
echo.
...
%PYTHON_CMD% gerar_homologacao_reabertura.py
...
echo ======================================================================
echo Arquivo: data\homologacao_reabertura.csv
echo.
echo Próximo passo: Execute validar_reabertura.py para validar
echo ======================================================================
echo.
pause
